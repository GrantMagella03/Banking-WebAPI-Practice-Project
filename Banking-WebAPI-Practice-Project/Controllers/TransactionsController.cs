...
namespace Banking_WebAPI_Practice_Project.Controllers
{
    ...
    public class TransactionsController : ControllerBase
    {
        ...
        public TransactionsController(Banking_WebAPI_Practice_ProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Transaction>> PostTransaction(Transaction transaction)
        {
          if (_context.Transactions == null)
          {
              return Problem("Entity set 'Banking_WebAPI_Practice_ProjectContext.Transaction'  is null.");
          }
