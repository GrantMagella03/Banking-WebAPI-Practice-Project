...
namespace Banking_WebAPI_Practice_Project.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        public AccountsController(Banking_WebAPI_Practice_ProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Account>> PostAccount(Account account)
        {
          if (_context.Accounts == null)
          {
              return Problem("Entity set 'Banking_WebAPI_Practice_ProjectContext.Account'  is null.");
          }
